...
const settingsResult = db.prepare(`
  SELECT value FROM settings WHERE key = 'filtering.maxTopTenPercent'
`).get();

const maxTopTenPercent = settingsResult?.value || 75;
console.log(`Current Setting - maxTopTenPercent: ${maxTopTenPercent}\n`);
